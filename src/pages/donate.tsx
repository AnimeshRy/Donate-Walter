...
export const DonationAmount: FunctionComponent<{
    ...
    return (
        <span
            className={`px-4 py-2 text-lg cursor-pointer bg-gray-light ${amount === value ? "border-2 border-yellow" : ""
                } `}
...
const donate = () => {
    ...
    useEffect(() => {
        const addPaypalScript = () => {
            ...
            script.src = `https://www.paypal.com/sdk/js?client-id=AYbTWXLwNKENhZjMxQf9RPXxHrHsIXA85oaQicPkbxgmVUL1SzPSOh7tNg4p-LxpNHxP9F82ZdXxUieA`;
            script.async = true;
